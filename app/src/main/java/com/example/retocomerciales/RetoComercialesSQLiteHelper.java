...
public class RetoComercialesSQLiteHelper extends SQLiteOpenHelper {
    ...
    String sqlLineas = "CREATE TABLE LINEAS (id_pedido INTEGER, cod_producto TEXT, cantidad INTEGER, pr_unidad DECIMAL(10,2), PRIMARY KEY (id_pedido,cod_producto), FOREIGN KEY (cod_producto) REFERENCES PRODUCTOS(cod_productos))"; //fk pedidos
